...
public class AppiumSimpleCalculatorTest1 extends AppiumTestBase {
    ...
    public void appiumSampleTest() throws Exception {
        ...
        WebElement seven = appiumDriver.findElementById("com.android.calculator2:id/digit_7");
        seven.click();
        WebElement plus = appiumDriver.findElementById("com.android.calculator2:id/op_add");
        plus.click();
        WebElement three = appiumDriver.findElementById("com.android.calculator2:id/digit_3");
        three.click();
        ...
        Assert.assertEquals(result.getText(), "10", "Result is not 10");
    }
